...
\"\n\
checkout_executable TCLSH \"/home/hongyunjie/Desktop/ns-allinone-2.35/bin/tclsh8.5\" tclsh \"\\\n\
When configured, ns found the right version of tclsh in\\\n\
/home/hongyunjie/Desktop/ns-allinone-2.35/bin/tclsh8.5\n\
but it doesn't seem to be there anymore, so\\\n\
...
\n\
set aodv2only [string first \"AODV2\" [$agent info class]]\n\
if {$aodv2only != -1} {\n\
...
AODV2 {\n\
set ragent [$self create-aodv2-agent $node]\n\
}\n\
AOMDV {\n\
...
\n\
Simulator instproc create-aodv2-agent { node } {\n\
set ragent [new Agent/AODV2 [$node node-addr]]\n\
